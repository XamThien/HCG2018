...
public class ketqua {
	 ...
	 */
	public static void main(String rtn) {
		try
		{
	 ...
	 */
	private void initialize(String rtn) {
		frmKtQua = new JFrame();
		frmKtQua.setTitle("Kết quả");
		frmKtQua.setBounds(100, 100, 450, 356);
